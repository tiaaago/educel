...
export async function getServerSideProps(ctx) {
    ...
    const getRole = await fetch(`${process.env.NEXTAUTH_URL}/api/roles/${ctx.query.id}`)
...
export default function Announcements(ctx) {
    ...
    const [isClass, setIsClass] = useState(role.isClass);
    ...
    function create() {
        ...
        fetch(`/api/roles/${role.id}`, {
            ...
            .then(data => {
                Swal.fire({
                    title: 'Editado!',
                    text: 'O cargo foi editado com sucesso.',
                    icon: 'success',
    ...
    return (
        <>
            <Head>
                <title>Administração - Editar Cargo</title>
            </Head>
                            ...
                            <form target="frame" className={styles.questions}>
                                <div className={styles.question}>
                                    <div className={styles.questionContainer}>
                                        ...
                                        <input className={styles.questionInput} placeholder="Nome do cargo" value={roleName} onChange={e => setRoleName(e.target.value)} required />
                                    </div>
                                </div>
                                <div className={styles.question}>
                                    <div className={styles.questionContainer}>
                        ...
                        <div className={base.contentSection}>
                            ...
                            <form target="frame" className={styles.questions}>
                                ...
                                <div className={styles.submitButtonArea}>
                                    <button className={base.blueButton} onClick={create}><i className={`fa-solid fa-pencil`}></i>Editar</button>
                                </div>
                            </form>
                        </div>
                    </div>
