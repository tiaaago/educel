...
export default function Announcements(ctx) {
    ...
    const [fixPost, setFixPost] = useState(false);
    ...
    function post() {
        ...
        fetch(`/api/posts`, {
            ...
            .then(data => {
                Swal.fire({
                    title: 'Enviado!',
                    text: 'O post foi feito com sucesso.',
                    icon: 'success',
    ...
    return (
        <>
            <Head>
                <title>Administração - Novo Post</title>
            </Head>
                ...
                <div className={base.content}>
                    <div className={base.contentWrapper}>
                        <div className={base.contentSection}>
                            <h3 className={base.contentSectionTitle}>Novo Post</h3>
                            ...
                            <form target="frame" className={styles.questions}>
                                ...
                                <div className={styles.question}>
                                    <div className={styles.questionContainer}>
                                        ...
                                        <label className={styles.switch}>
                                            <input className={styles.checkbox} id={ctx.id} type="checkbox" defaultChecked={fixPost} onChange={e => setFixPost(e.target.checked)} />
                                ...
                                <div className={styles.submitButtonArea}>
                                    <button className={base.blueButton} onClick={post}><i className={`fas fa-paper-plane`}></i>Publicar</button>
                                </div>
                            </form>
                        </div>
                    </div>
